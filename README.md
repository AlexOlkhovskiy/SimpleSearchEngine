Простейший поисковый движок (текстовый). Написан в рамках прохождения курса по языку Kotlin, в частности изучения темы работы с коллекциями, строками и индексации строк https://hyperskill.org/projects/89
